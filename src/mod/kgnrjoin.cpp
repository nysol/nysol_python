...
// -----------------------------------------------------------------------------
const char * kgNrjoin::_ipara[] = {"i","m",""};
const char * kgNrjoin::_opara[] = {"o",""};
...
// -----------------------------------------------------------------------------
void kgNrjoin::setArgsMain(void)
{
...
// パラメータセット＆入出力ファイルオープン
// -----------------------------------------------------------------------------
void kgNrjoin::setArgs(int inum,int *i_p,int onum ,int *o_p)
{
	int iopencnt = 0;
	int oopencnt = 0;
	try{
...
{
    ((kgNrjoin*)arg)->runErrEnd();
}

int kgNrjoin::run(int inum,int *i_p,int onum, int* o_p,string &msg)
{
	int sts=1;
