...
// -----------------------------------------------------------------------------
const char * kgRjoin::_ipara[] = {"i","m",""};
const char * kgRjoin::_opara[] = {"o",""};
...
// 入出力ファイルオープン
// -----------------------------------------------------------------------------
void kgRjoin::setArgs(int inum,int *i_p,int onum ,int *o_p)
{
	int iopencnt = 0;
	int oopencnt = 0;
	try{
...
{
    ((kgRjoin*)arg)->runErrEnd();
}

int kgRjoin::run(int inum,int *i_p,int onum, int* o_p,string &msg)
{
	int sts=1;
