...
// -----------------------------------------------------------------------------
const char * kgSim::_ipara[] = {"i",""};
const char * kgSim::_opara[] = {"o",""};

kgSim::kgSim(void)
{
	_name    = "kgsim";
	_version = "###VERSION###";
	_paralist = "a=,f=,i=,o=,k=,c=,-d,bufcount=,-q,-n";
...
int kgSim::run(int inum,int *i_p,int onum, int* o_p,string &msg)
{
	int sts=1;
