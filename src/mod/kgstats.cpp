...
// -----------------------------------------------------------------------------
const char * kgStats::_ipara[] = {"i",""};
const char * kgStats::_opara[] = {"o",""};
...
{
    ((kgStats*)arg)->runErrEnd();
}

int kgStats::run(int inum,int *i_p,int onum, int* o_p,string &msg)
{
	int sts=1;
