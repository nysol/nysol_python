...
// -----------------------------------------------------------------------------
const char * kgTrafld::_ipara[] = {"i",""};
const char * kgTrafld::_opara[] = {"o",""};
...
kgTrafld::kgTrafld(void)
{
	...
	_paralist = "f=,i=,o=,a=,delim=,delim2=,-r,-valOnly";
...
// 入出力ファイルオープン
// -----------------------------------------------------------------------------
void kgTrafld::setArgsMain(void)
{
	_iFile.read_header();
...
// 入出力ファイルオープン
// -----------------------------------------------------------------------------
void kgTrafld::setArgs(int inum,int *i_p,int onum ,int *o_p)
{
	int iopencnt = 0;
	int oopencnt = 0;
	try{
...
{
    ((kgTrafld*)arg)->runErrEnd();
}

int kgTrafld::run(int inum,int *i_p,int onum, int* o_p,string &msg)
{
	int sts=1;
