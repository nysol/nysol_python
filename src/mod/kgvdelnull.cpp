...
// -----------------------------------------------------------------------------
const char * kgVdelnull::_ipara[] = {"i",""};
const char * kgVdelnull::_opara[] = {"o",""};
...
{
    ((kgVdelnull*)arg)->runErrEnd();
}

int kgVdelnull::run(int inum,int *i_p,int onum, int* o_p,string &msg)
{
	int sts=1;
