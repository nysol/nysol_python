...
// -----------------------------------------------------------------------------
const char * kgVsort::_ipara[] = {"i",""};
const char * kgVsort::_opara[] = {"o",""};
...
// 入出力ファイルオープン
// -----------------------------------------------------------------------------
void kgVsort::setArgs(int inum,int *i_p,int onum ,int *o_p)
{
	int iopencnt = 0;
	int oopencnt = 0;
	try{
...
{
    ((kgVsort*)arg)->runErrEnd();
}

int kgVsort::run(int inum,int *i_p,int onum, int* o_p,string &msg)
{
	int sts=1;
