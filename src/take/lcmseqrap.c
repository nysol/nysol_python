...
PyObject* lcmseq_run(PyObject* self, PyObject* args){
...
PyObject* lcmseq_run(PyObject* self, PyObject* args, PyObject* kwds){
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "sss|ssssssssssssssssssssssssss", 
					...
					&pval[25],&pval[26],&pval[27],&pval[28])){
			return NULL;
		}
...
//	{"lcmseq_run", reinterpret_cast<PyCFunction>(lcmseq_run), METH_VARARGS|METH_KEYWORDS  },
	{"lcmseq_run", (PyCFunction)lcmseq_run, METH_VARARGS  },
	{NULL}
};
...
void init_lcmseqlib(void){
	Py_InitModule("_lcmseqlib", takemethods);
}
